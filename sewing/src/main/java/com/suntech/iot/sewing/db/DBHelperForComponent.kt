package com.suntech.iot.sewing.db
 ...
 */
    ...
    fun add(wosno: String, shift_id:String, shift_name:String, styleno: String, model:String, size:String, target: Int, actual: Int, defective: Int): Long {
